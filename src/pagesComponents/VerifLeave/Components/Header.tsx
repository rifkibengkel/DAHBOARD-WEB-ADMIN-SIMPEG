...
const VerifLeaveHeader = () => {
  ...
  return (
    <Box sx={{ display: "flex", alignItems: "center" }}>
      <Typography fontSize="22px">Approval Cuti</Typography>
      <Box
        sx={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        >
          <SelectDefault placeholder="Jenis Cuti" value={""} options={[]} />
        </FormControl>
        <FormControl
          sx={{
            width: 150,
...
export default VerifLeaveHeader;
