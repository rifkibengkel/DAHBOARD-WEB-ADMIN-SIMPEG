...
type DateTimeValidationProps = FieldProps & TextFieldProps;

const DateTimeValidation: React.FC<DateTimeValidationProps> = React.memo((props) => {
...
DateTimeValidation.displayName = "DateTimeValidation";
